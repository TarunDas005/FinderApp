...
public class LocationTrackerFinal implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public LocationTrackerFinal(Context context) {
